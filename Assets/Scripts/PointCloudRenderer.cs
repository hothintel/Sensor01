...
public class PointCloudRenderer : MonoBehaviour
{
    ...
    public void Render(Vector3[] arrVertices, Color pointColor, Vector3 closestPoint)
    {
        int nPoints, nChunks;
        if (arrVertices == null)
        {
        ...
        for (int i = 0; i < nChunks; i++)
        {
            ...
            renderer.UpdateMesh(arrVertices, nPointsToRender, offset, pointColor, closestPoint);
